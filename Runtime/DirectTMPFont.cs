// ==========================================
// DirectTMPFont  ("Direct Font" in the Inspector)
...
namespace UnityDirectTMP
{
    ...
    public sealed class DirectTMPFont : MonoBehaviour, ITextPreprocessor
    {
        ...
        private TMP_FontAsset Build(Font file) => file == null ? null : DirectFont.Load(file);
        ...
        private static void AddFallback(TMP_FontAsset asset, Font file)
        {
            ...
            TMP_FontAsset other = DirectFont.Load(file);
