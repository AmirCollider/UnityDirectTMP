// ==========================================
// DirectTMPFontInspector
// The Inspector for the Direct Font component, and the
// only menu this package adds.
//
...
{
    [CustomEditor(typeof(DirectTMPFont))]
    [CanEditMultipleObjects]
    public sealed class DirectTMPFontInspector : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (targets.Length == 1) { DrawStatus((DirectTMPFont)target); }
        }

        // ==========================================
        // What is actually going on with this label
        // ==========================================
        private static void DrawStatus(DirectTMPFont direct)
        {
        ...
        private static string Diagnose(DirectTMPFont direct)
        {
        ...
        // The menu
        // ==========================================
        private const string Menu = "Tools/Unity DirectTMP/";
        ...
        private static void AddToSelection()
        {
            ...
            foreach (GameObject go in Selection.gameObjects)
            {
                ...
                if (go.GetComponent<DirectTMPFont>() != null) { continue; }

                Undo.AddComponent<DirectTMPFont>(go);
                added++;
            }

            Debug.Log(added == 0
                ? "[DirectTMP] Select one or more TextMeshPro labels first."
                : $"[DirectTMP] Added Direct Font to {added} label(s). Assign a .ttf on each.");
        }
